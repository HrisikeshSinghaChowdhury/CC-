...
Enter particulars of node ( a x^y ) :
Enter coefficient (a) :2
Enter index in descending order (y) :6
Do you want to add another node (Y / N)n

Enter particulars of Second polynomial :
Enter particulars of node ( a x^y ) :
Enter coefficient (a) :6
Enter index in descending order (y) :7
Do you want to add another node (Y / N)yEnter particulars of node ( a x^y ) :
Enter coefficient (a) :8
Enter index in descending order (y) :12
Do you want to add another node (Y / N)n

First polynomial :      2 x^6

Second polynomial :     6 x^7  +  8 x^12
